...
// map helps to acess each nested object using object .value
...
const allOrders = Object.values(orders).map(order => {
  ...
  return {
    ...order, 
    // ?: tenery operator is same as a conditional statement
...
//1.create models
//2 .create fuctions
// create a function to add new book
